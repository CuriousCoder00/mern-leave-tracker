  ...
  return (
    <form className="flex flex-col gap-4 w-full mt-4">
      ...
      <div className="flex text-xs">
        <div className="mb-4">
          <ul>
            <li className="flex items-center gap-2 text-slate-300" id="minLength">
              {password.length >= 8 ? (
            ...
            <li className="flex items-center gap-2 text-slate-300" id="uppercase">
              {/[A-Z]/.test(password) ? (
                <FaCheck className="text-green-500" />
              ) : (
                <FaTimes className="text-red-500" />
            ...
            <li className="flex items-center gap-2 text-slate-300" id="lowercase">
              {/[a-z]/.test(password) ? (
                <FaCheck className="text-green-500" />
              ) : (
                <FaTimes className="text-red-500" />
            ...
            <li className="flex items-center gap-2 text-slate-300" id="symbol">
              {/[@$!%*?&]/.test(password) ? (
                <FaCheck className="text-green-500" />
              ) : (
                <FaTimes className="text-red-500" />
        ...
        <div>
          ...
          {matchResultError && (
            <p className="text-red-400">*{matchResultError}</p>
          )}
        </div>
      </div>
